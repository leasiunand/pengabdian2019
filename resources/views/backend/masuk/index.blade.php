                  ...
                  @foreach($surat_masuk as $masuk)
                    <tr>
                      ...
                      <td class="text-right">
                        ...
                        <a href="{{route('surat-masuk.show',$masuk->surat_id)}}" class="btn btn-primary btn-mini waves-effect waves-light" data-toggle="tooltip" data-placement="left" title="Edit"><i class="ion-eye"></i> Detail</a>
