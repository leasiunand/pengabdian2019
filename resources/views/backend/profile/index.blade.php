              ...
              <div class="row">
                  <div class="col-md-12">
                      ...
                      <div class="social-wallpaper">
                          <img src="{{asset('editor/assets/images/social/img1.jpg')}}" class="img-fluid width-100" alt="" />
                      ...
                      <div class="social-timeline-left">
                          ...
                          <div class="card">
                              <div class="social-profile">
                                  <img class="img-fluid width-100" src="{{asset('editor/assets/images/social/profile.jpg')}}" alt="">
                          ...
                          <div class="card">
                              ...
                              <div class="card-block user-box">
                                  ...
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-1.jpg')}}" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="user image">
                                  ...
                                  <div class="media m-b-10">
                                      <a class="media-left" href="#!">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-2.jpg')}}" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="user image">
                                  ...
                                  <div class="media m-b-10">
                                      <a class="media-left" href="#!">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-3.jpg')}}" alt="Generic placeholder image" data-toggle="tooltip" data-placement="top" title="user image">
                                  <div class="live-status bg-danger"></div>
                              </a>
                                      <div class="media-body">
                                          <div class="chat-header">Josephin Doe</div>
                          ...
                          <div class="card">
                              ...
                              <div class="card-block friend-box">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-1.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-2.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-3.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-4.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-1.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-4.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-3.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                  <img class="media-object img-radius" src="{{asset('editor/assets/images/avatar-2.jpg')}}" alt="" data-toggle="tooltip" data-placement="top" title="user image">
                                          ...
                                          <div class="row timeline-right p-t-35">
                                              <div class="col-2 col-sm-2 col-xl-1">
                                                  <div class="social-timelines-left">
                                                      <img class="img-radius timeline-icon" src="{{asset('editor/assets/images/avatar-2.jpg')}}" alt="">
                                                  </div>
                                              </div>
                                              <div class="col-10 col-sm-10 col-xl-11 p-l-5 p-b-35">
                                                  <div class="card">
                                                      ...
                                                      <img src="{{asset('editor/assets/images/timeline/img1.jpg')}}" class="img-fluid width-100" alt="">
                                                      ...
                                                      <div class="card-block user-box">
                                                          ...
                                                          <div class="media m-b-20">
                                                              <a class="media-left" href="#">
                                                          <img class="media-object img-radius m-r-20" src="{{asset('editor/assets/images/avatar-1.jpg')}}" alt="Generic placeholder image">
                                                      </a>
                                                          ...
                                                          <div class="media m-b-20">
                                                              <a class="media-left" href="#">
                                                          <img class="media-object img-radius m-r-20" src="{{asset('editor/assets/images/avatar-2.jpg')}}" alt="Generic placeholder image">
                                                      </a>
                                                              <div class="media-body b-b-muted social-client-description">
                                                          ...
                                                          <div class="media">
                                                              <a class="media-left" href="#">
                                                          <img class="media-object img-radius m-r-20" src="{{asset('editor/assets/images/user.png')}}" alt="Generic placeholder image">
                                                      </a>
                                                              <div class="media-body">
                                                                  <form class="">
                                                                      <div class="">
                                                  ...
                                                  <div class="col-lg-6 col-md-12">
                                                      <table class="table table-responsive m-b-0">
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td class="social-user-name b-none text-muted"><a href="https://colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="582c3d2b2c183f35393134763b3735">[email&#160;protected]</a></td>
                                                          </tr>
                                                          <tr>
                                          ...
                                          <div class="demo-gallery">
                                              <ul id="profile-lightgallery" class="row">
                                                  <li class="col-md-4 col-lg-2 col-sm-6 col-xs-12">
                                                      <a href="{{asset('editor/assets/images/light-box/l1.jpg')}}" data-toggle="lightbox" data-title="A random title" data-footer="A custom footer text">
                                                  <img src="{{asset('editor/assets/images/light-box/sl1.jpg')}}" class="img-fluid" alt="">
                                              </a>
                                                  </li>
                                                  <li class="col-md-4 col-lg-2 col-sm-6 col-xs-12">
                                                      <a href="{{asset('editor/assets/images/light-box/l1.jpg')}}" data-toggle="lightbox" data-title="A random title" data-footer="A custom footer text">
                                          ...
                                          <div class="card-block post-timelines">
                                              ...
                                              <div class="media bg-white d-flex">
                                                  <div class="media-left media-middle">
                                                      <a href="#">
                                                  <img class="media-object" src="{{asset('editor/assets/images/timeline/img2.png')}}" alt="">
                                              </a>
                                                  </div>
...
@section('script')
  <script type="text/javascript" src="{{asset('editor/assets/pages/social-timeline/social.js')}}"></script>
@stop
